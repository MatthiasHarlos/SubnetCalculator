...
public class SubnetCalculatorTest {
    ...
    void testcalculateIDs() {
        ...
        Assertions.assertEquals(SubnetCalculator.calculateIDs("11000000101010000000000100000001", "11111111111111111111111111100000"), "ID 0= 192.168.1.0 \b/27 ID 32= 192.168.1.32 ID 64= 192.168.1.64 ID 96= 192.168.1.96 ID 128= 192.168.1.128 ID 160= 192.168.1.160 ID 192= 192.168.1.192 ID 224= 192.168.1.224 \b/27");
    }
