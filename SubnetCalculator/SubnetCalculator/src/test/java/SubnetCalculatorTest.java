...
public class SubnetCalculatorTest {
    ...
    void testCalculateIPs() {
        ...
        Assertions.assertEquals(calculator.iPs("ID 0= 192.0.0.0/14|ID 4= 192.4.0.0/14|ID 8= 192.8.0.0/14|ID 12= 192.12.0.0/14|\" +\n" +
        ...
        Assertions.assertEquals(calculator.iPs("ID 0= 192.168.1.0/27|ID 32= 192.168.1.32/27|ID 64= 192.168.1.64/27|" +
